...
export const createUser = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    // Исключаем проверку registration_date, если оно не передано
    // (Можно удалить это поле из DTO или сделать его необязательным)
    ...
    const newUser = userRepository.create({
      ...
      // Если регистрационная дата не передана — используем текущую дату
